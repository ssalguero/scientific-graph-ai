...
**Status:** **SPE-1.V PASS** · SPE-1.C BUILD **NOT STARTED**  
...
SPE-1.V PASS ≠ SPE-1.C BUILD authorization
SPE-1.V PASS ≠ Commercial Test Ready
SPE-1.V ≠ EXPORT-3 ZIP · AIR-1 · ARCH-U · OBS-1 · UXC-2 · PROD-3 reopen
SPE-1.V ≠ Layout / Product Face redesign (Commercial Readiness dependency)
```
