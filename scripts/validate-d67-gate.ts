/**
 * D67.9 — Session Restore Foundation umbrella gate.
 * Executes: validate:d65-gate · validate:d66-gate · validate:d67.
 */
import {
  createCaseRecorder,
  emitGateSummary,
...
const SUB_GATE_SCRIPTS: { npmScript: string; gateId: string }[] = [
  ...
  { npmScript: "validate:d67", gateId: "d67" },
];
...
const rollup = {
  ...
  final: allPass ? "D67 GATE PASS" : "D67 GATE FAIL",
};

console.log(JSON.stringify(rollup, null, 2));
console.log(allPass ? "\nD67 GATE PASS" : "\nD67 GATE FAIL");

emitGateSummary("d67-gate", results);
