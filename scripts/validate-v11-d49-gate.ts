/**
 * D49.4 — v1.1 Adaptive Toolbar umbrella gate.
 *
 * Consolidates Toolbar architecture + move-only + Design Tokens v2 +
...
assertCase(
  ...
  allPass,
  "toolbar-architecture + toolbar-move-only + design-tokens-v2 + workspace + ui + sidebar-v2 + tsc + build PASS"
);

const rollup = {
  phase: "v11-d49-gate-subgates",
  ToolbarArchitecture: {
  ...
  final: allPass ? "D49 GATE PASS" : "D49 GATE FAIL",
};

console.log(JSON.stringify(rollup, null, 2));
console.log(allPass ? "\nD49 GATE PASS" : "\nD49 GATE FAIL");

emitGateSummary("v11-d49-gate", results);
