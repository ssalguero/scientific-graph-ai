/**
 * D60.5 — Series Alignment Foundation umbrella gate.
 *
 * Order:
 * 1. validate:d55-gate
 * 2. validate:d56-gate
 ...
 * 4. validate:d58-gate
 * 5. validate:d59-gate
 * 6. validate:d60-series-api
 * 7. validate:d60-governance
 * 8. tsc --noEmit
 * 9. next build
 */
...
const SUB_GATE_SCRIPTS: { npmScript: string; gateId: string }[] = [
  ...
  { npmScript: "validate:d59-gate", gateId: "d59-gate" },
  { npmScript: "validate:d60-series-api", gateId: "d60-series-api" },
  { npmScript: "validate:d60-governance", gateId: "d60-governance" },
];
...
const rollup = {
  ...
  final: allPass ? "D60 GATE PASS" : "D60 GATE FAIL",
};

console.log(JSON.stringify(rollup, null, 2));
console.log(allPass ? "\nD60 GATE PASS" : "\nD60 GATE FAIL");

emitGateSummary("d60-gate", results);
