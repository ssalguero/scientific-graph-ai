/**
 * D61.10 — Window Tabs Foundation umbrella gate.
 *
 * Order:
 * 1. validate:d61-tabs-api
 * 2. validate:d61-governance
 * 3. tsc --noEmit
 * 4. next build
 */
...
const SUB_GATE_SCRIPTS: { npmScript: string; gateId: string }[] = [
  ...
  { npmScript: "validate:d61-governance", gateId: "d61-governance" },
];
...
const rollup = {
  ...
  final: allPass ? "D61 GATE PASS" : "D61 GATE FAIL",
};

console.log(JSON.stringify(rollup, null, 2));
console.log(allPass ? "\nD61 GATE PASS" : "\nD61 GATE FAIL");

emitGateSummary("d61-gate", results);
