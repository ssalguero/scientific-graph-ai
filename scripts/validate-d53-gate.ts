/**
 * D53.5 — Dock Interactions umbrella gate.
 *
 * Order:
 * 1. validate:d53-api-freeze
 * 2. validate:d53-interactions
 * 3. validate:d53-governance
 * 4. tsc --noEmit
 */
...
const SUB_GATE_SCRIPTS: { npmScript: string; gateId: string }[] = [
  ...
  { npmScript: "validate:d53-interactions", gateId: "d53-interactions" },
  { npmScript: "validate:d53-governance", gateId: "d53-governance" },
];
...
const rollup = {
  ...
  final: allPass ? "D53 GATE PASS" : "D53 GATE FAIL",
};

console.log(JSON.stringify(rollup, null, 2));
console.log(allPass ? "\nD53 GATE PASS" : "\nD53 GATE FAIL");

emitGateSummary("d53-gate", results);
