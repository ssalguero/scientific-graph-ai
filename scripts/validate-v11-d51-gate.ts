/**
 * D51.4 — v1.1 Docking Foundation umbrella gate.
 *
 * Consolidates Docking foundation + Inspector + Toolbar + Design Tokens v2 +
...
assertCase(
  ...
  allPass,
  "docking-foundation + inspector-foundation + toolbar-architecture + toolbar-move-only + design-tokens-v2 + workspace + ui + sidebar-v2 + tsc + build PASS"
);

const rollup = {
  phase: "v11-d51-gate-subgates",
  DockingFoundation: {
    pass: dockingPass,
    exitCode:
  ...
  final: allPass ? "D51 GATE PASS" : "D51 GATE FAIL",
};

console.log(JSON.stringify(rollup, null, 2));
console.log(allPass ? "\nD51 GATE PASS" : "\nD51 GATE FAIL");

emitGateSummary("v11-d51-gate", results);
