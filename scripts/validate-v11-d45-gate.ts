/**
 * D45.5 — v1.1 UI Foundation umbrella gate.
 *
 * Consolidates architecture + smoke gates, TypeScript, and production build.
...
const SUB_GATE_SCRIPTS: { npmScript: string; gateId: string }[] = [
  ...
  {
    npmScript: "validate:ui-button-panel-smoke",
    gateId: "ui-button-panel-smoke",
  },
  {
...
assertCase(
  ...
  "all D45 sub-gates + tsc + build PASS"
);

console.log(
  JSON.stringify(
    {
      phase: "v11-d45-gate-subgates",
...
emitGateSummary("v11-d45-gate", results);
